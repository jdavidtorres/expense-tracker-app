...
public class MonthlySummary
{
	...
	[JsonPropertyName("totalInvoices")] public decimal TotalInvoices { get; set; }

	[JsonPropertyName("totalExpenses")] public decimal TotalExpenses => TotalSubscriptions + TotalInvoices;
...
public class YearlySummary
{
	...
	[JsonPropertyName("monthlyBreakdown")] public List<MonthlySummary> MonthlyBreakdown { get; set; } = new();
}
